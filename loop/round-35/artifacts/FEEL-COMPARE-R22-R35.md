# BAR-FEEL R35 comparison

R22 is the committed pre-R35 baseline. R34 made no physics/feel change, so its
46/46 baseline is the same R22 verdict. R35 is measured from
`lap-a-r35-codex.json` with the three permitted wall/reverse/steering changes.

| ID | Metric | R22 / R34 actual | R35 actual | Delta | R35 |
|---|---|---:|---:|---:|:---:|
| 2.1 | tick_dt_variance | 0 | 0 | 0 | PASS |
...
| 2.4 | nan_or_inf_frames | 0 | 0 | 0 | PASS |
...
| 4.3 | tier2_charge_time_s | 2.0083333333333337 | 2.0083333333333337 | 0 | PASS |
| 4.4 | tier3_charge_time_s | 3.5083333333333333 | 3.5083333333333333 | 0 | PASS |
| 4.5 | car_lengths_gained_tier2 | 1.5603197783466292 | 1.5603197783466292 | 0 | PASS |
| 4.6 | car_lengths_gained_tier1 | 0.6094193161358005 | 0.6094193161358005 | 0 | PASS |
| 4.7 | car_lengths_gained_tier3 | 3.5947178526799948 | 5.872681336663079 | +2.277963483983084 | FAIL |
...
| 5.2 | turn_radius_at_95pct_u | 8.447153448094879 | 8.43612105171371 | -0.011032396381169 | PASS |
| 5.3 | yaw_settle_time_s | 0.17499999999999982 | 0.17499999999999982 | 0 | PASS |
| 5.4 | yaw_overshoot_ratio | 0 | 0 | 0 | PASS |
...
| 5.7 | turn_radius_at_30pct_u | 4.984649202094081 | 4.992102869181939 | +0.007453667087858 | PASS |
| 5.8 | turn_radius_at_60pct_u | 6.890051615003511 | 6.854127399677173 | -0.035924215326338 | PASS |
| 5.9 | turn_radius_monotonic | true | true | same | PASS |
| 6.1 | wall_speed_retention | 0.588189361783879 | 0.5906631456079496 | +0.002473783824071 | PASS |
| 6.2 | wall_head_on_retention | 0.19588542742629103 | 0.19588542742629103 | 0 | PASS |
| 6.3 | collision_recovery_time_s | 0.2791666666666666 | 0.1833333333333334 | -0.0958333333333332 | FAIL |
| 6.4 | kart_kart_impulse_symmetry | 1 | 1 | 0 | PASS |
| 6.5 | wall_stick_frames | 2 | 2 | 0 | PASS |
| 7.1 | air_control_yaw_rate_ratio | 0.24166038031670278 | 0.24166038031670278 | 0 | PASS |
| 7.2 | gravity_us2 | 30 | 30 | 0 | PASS |
| 7.3 | landing_speed_retention | 1 | 1 | 0 | PASS |
| 7.4 | hard_landing_retention | 0.7645012038641997 | 0.7645012038641997 | 0 | PASS |
| 7.5 | airborne_to_grounded_latency_ticks | 0 | 0 | 0 | PASS |
| 8.1 | input_to_sim_latency_ticks | 0 | 0 | 0 | PASS |
| 8.2 | input_buffer_window_ms | 91.66666666666667 | 91.66666666666667 | 0 | PASS |
| 8.3 | throttle_deadzone | 0 | 0 | 0 | PASS |
...
Result: 44/46 PASS, 2/46 FAIL. The validator's largest gap is §6.3
(`0.1833333333333334`, below `[0.20, 0.45]`). §4.10 remains
`0.9697186324532083`, only `0.0002813675467917` below its `0.97` upper bound;
its window was not changed.
