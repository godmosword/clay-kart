...
| 4.5 | `car_lengths_gained_tier2` | `[1.5, 2.5]` | **核心手感**：tier2 釋放相對不漂移基準線的領先 |
...
**設計意圖：** 4.5 是整個 W2 的心臟。玩家對 mini-turbo 的滿意度來自「肉眼可見拉開一個明確身位」——低於 1.5 車身感覺沒用，高於 2.5 車身則不漂移的玩法完全不可行。
